...
import '../../../Popups/Mypage/Mypage_popup.dart';
        ...
        children: [
              ...
              child: Stack(
                children: [
                  ...
                  Positioned(
                      ...
                      child: Image.asset("assets/Mypage/edit_icon.png",width: size.width*0.07,))
                ],
              ),
            ),
          ),
          Column(
            ...
            children: [
              ...
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text("sinminseok12@naver.com",style: TextStyle(color: Colors.grey,fontSize: 12),),
              )
            ],
          ),
